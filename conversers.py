...
from config import VICUNA_PATH, LLAMA_PATH, ATTACK_TEMP, TARGET_TEMP, ATTACK_TOP_P, TARGET_TOP_P, MAX_PARALLEL_STREAMS, VICUNA_PATH_v1, QWEN2_PATH
...
def load_attack_and_target_models(args):
    ...
    attack_llm = AttackLLM(model_name = args.attack_model,
                        ...
                        max_n_attack_attempts = args.max_n_attack_attempts, # init to 5
...
class AttackLLM():
    ...
    def __init__(self, 
        ...
        if "vicuna" in model_name or "llama" in model_name or "vicuna_v1" in model_name or "qwen2" in model_name:
...
def load_indiv_model(model_name):
    ...
    if model_name in ["gpt-3.5-turbo", "gpt-4", 'gpt-4-1106-preview']:
        ...
        if 'vicuna' in model_path.lower() or 'vicuna_v1' in model_path.lower() or 'qwen2' in model_path.lower():
